...
def main(model_path: str, dataset: str, dataset_column: str, batch_size: int, max_length: int,
    ...
    with open(f'{model_name}_acree_{str(layers_to_skip)}_layer_distances.csv', 'w', newline='') as csvfile:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--prune_type", type=str, default="layer", help="Type of pruning to apply ('layer', 'block').")
