...
python main.py --model meta-llama/Llama-2-7b-hf --prune_method wanda --sparsity_ratio 0.5 --sparsity_type unstructured --save /home/as26840@ens.ad.etsmtl.ca/repos/wanda/logs